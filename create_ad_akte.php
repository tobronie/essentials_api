...
`ak_foto_akte_saudara`, `ak_tgl_upload`) VALUES ('$ak_judul', '$ak_foto_surat_kelahiran', '$ak_foto_kk', '$ak_foto_ktp_ayah',
'$ak_foto_nikah_ayah', '$ak_foto_ktp_ibu','$ak_foto_nikah_ibu', '$ak_foto_ktp_saksi_satu', '$ak_foto_ktp_saksi_dua',
'$ak_foto_ijasah_bersangkutan', '$ak_foto_akte_saudara', '$ak_tgl_upload')";
