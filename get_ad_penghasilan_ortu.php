...
if ($id_penghasilan) {
    $query = "SELECT penghasilan_ortu.id_penghasilan, penghasilan_ortu.id_user, user.nama AS nama, user.no_hp AS no_hp, user.email AS email, penghasilan_ortu.has_judul,
